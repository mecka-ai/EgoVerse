### Vendored verbatim from dreamzero groot/vla/model/n1_5/action_head/base_action_head.py
### Base class that WANPolicyHead (wan_flow_matching_action_tf.py) subclasses.
