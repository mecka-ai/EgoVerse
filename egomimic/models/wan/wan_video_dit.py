...
from egomimic.models.wan.utils import hash_state_dict_keys
from egomimic.models.wan.wan_video_camera_controller import SimpleAdapter
...
class Head(nn.Module):
    ...
    def forward(self, x, t_mod):
        ...
        shift, scale = (
            self.modulation.repeat(batch_size, 1, 1).to(
