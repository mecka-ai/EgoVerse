"""Web viewer for the OFFLINE in-distribution validation videos of the 8
...
app = modal.App("offline-val-viewer", image=image)
...
# (short label, run dir under offline_val_indist/)
RUNS = [
...
@modal.asgi_app(label="offline-val-viewer")
def viewer():
    import json
    import os
    import re
