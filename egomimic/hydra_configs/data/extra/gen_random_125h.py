"""Build a random allowlist of mecka_data_v2 episodes summing to ~125h total, so
the default 80/20 (by-episode, seed 42) MultiDataset split yields ~100h train.
...
TARGET_TOTAL_H = 125.0    # 80% ≈ 100h train
SELECT_SEED = 7           # selection shuffle (split uses seed 42 at runtime)
OUT = f"{REPO}/egomimic/hydra_configs/data/extra/mecka_random_125h.json"
